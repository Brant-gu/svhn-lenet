...
> Code review and documentation polished with Claude Code.

## Overview

PyTorch implementation of LeNet for SVHN digit classification. Dependencies: PyTorch, torchvision, tqdm.
